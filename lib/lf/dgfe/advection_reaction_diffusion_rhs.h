...
template<typename SCALAR, typename DIFFUSION_COEFF, typename ADVECTION_COEFF, typename EDGESELECTOR, typename MESHFUNC_F, typename MESHFUNC_gD, typename MESHFUNC_gN, typename TMPMATRIX, typename DUMMYMESHFUNC>
...
public:
    ...
    AdvectionReactionDiffusionRHSAssembler(std::shared_ptr<const lf::dgfe::DGFESpace> dgfe_space_ptr, MESHFUNC_F f, MESHFUNC_gD gD, MESHFUNC_gN gN,
                                    ...
                                    L2ProjectionSqrtAGradBasis<SCALAR, DUMMYMESHFUNC> &l2_proj)
