...
TEST(meshFunction, l2BarycenterError){
    ...
    error_check += std::abs(dgfe_lambda_0(mapped_bary_coords.col(0)) - true_sol_lambda(mapped_bary_coords.col(0))) * /* area */ 0.25;
    ...
    error_check += std::abs(dgfe_lambda_1(mapped_bary_coords.col(0)) - true_sol_lambda(mapped_bary_coords.col(0))) * /* area */ 0.25;
    ...
    error_check += std::abs(dgfe_lambda_2(mapped_bary_coords.col(0)) - true_sol_lambda(mapped_bary_coords.col(0))) * /* area */ 0.25;
    ...
    error_check += std::abs(dgfe_lambda_3(mapped_bary_coords.col(0)) - true_sol_lambda(mapped_bary_coords.col(0))) * /* area */ 0.25;
    ...
    double mesh_func_l2_error = lf::dgfe::L2ErrorBarycenter(dgfe_mesh_function, true_sol_lambda);
